...
struct SPVRTPFXParserTexture
{
	...
	SPVRTPFXParserTexture(const SPVRTPFXParserTexture& rhs)
	{
		Copy(rhs);
	}

	SPVRTPFXParserTexture& operator=(const SPVRTPFXParserTexture& rhs)
	{
		if(&rhs != this)
			Copy(rhs);
	...
	void Copy(const SPVRTPFXParserTexture& rhs)
	{
		PVRTPFXCreateStringCopy(&pszName, rhs.pszName);
		PVRTPFXCreateStringCopy(&pszFile, rhs.pszFile);
		bRenderToTexture = rhs.bRenderToTexture;
		nMin	 = rhs.nMin;
		nMag	 = rhs.nMag;
		nMIP	 = rhs.nMIP;
		nWrapS	 = rhs.nWrapS;
...
struct SPVRTPFXParserEffectTexture
{
	...
	SPVRTPFXParserEffectTexture() : pszName(NULL)
	{
	}

	~SPVRTPFXParserEffectTexture()
	{
		FREE(pszName);
	}

	SPVRTPFXParserEffectTexture(const SPVRTPFXParserEffectTexture& rhs)
	{
		Copy(rhs);
	}

	SPVRTPFXParserEffectTexture& operator=(const SPVRTPFXParserEffectTexture& rhs)
	{
		if(&rhs != this)
			Copy(rhs);
	...
	void Copy(const SPVRTPFXParserEffectTexture& rhs)
	{
		PVRTPFXCreateStringCopy(&pszName, rhs.pszName);
		nNumber		= rhs.nNumber;
		u32Type		= rhs.u32Type;
...
public:
	...
	*****************************************************************************/
	unsigned int FindTextureIndex(const CPVRTString& TextureName, unsigned int uiEffect);

public:
    SPVRTPFXParserHeader	m_sHeader;

	CPVRTArray<SPVRTPFXParserTexture>	m_psTexture;
