...
int main()
{
	...
	*/
	...
	result = system->createSound("lib/fmod/core/examples/media/drumloop.wav"/*Common_MediaPath("drumloop.wav")*/, FMOD_DEFAULT, 0, &sound1);
	ERRCHECK(result);

	result = sound1->setMode(FMOD_LOOP_OFF);    /* drumloop.wav has embedded loop points which automatically makes looping turn on, */
	ERRCHECK(result);                           /* so turn it off here.  We could have also just put FMOD_LOOP_OFF in the above CreateSound call. */

	result = system->createSound("lib/fmod/core/examples/media/jaguar.wav"/*Common_MediaPath("jaguar.wav")*/, FMOD_DEFAULT, 0, &sound2);
	ERRCHECK(result);

	result = system->createSound("lib/fmod/core/examples/media/swish.wav"/*Common_MediaPath("swish.wav")*/, FMOD_DEFAULT, 0, &sound3);
	ERRCHECK(result);
