...
//------------------------------------------------------------------------------
// Method:    AIStateGrabbingCoin1
// Returns:   
// 
// Constructor.
//------------------------------------------------------------------------------
AIStateGrabbingCoin1::AIStateGrabbingCoin1()
{
}
...
//------------------------------------------------------------------------------
void AIStateGrabbingCoin1::Enter()
{
	...
	m_pTargetGameObject = pController->GetGameObject()->GetManager()->GetGameObject("Coin1");
}
...
//------------------------------------------------------------------------------
void AIStateGrabbingCoin1::Update(float p_fDelta)
{
...
//------------------------------------------------------------------------------
void AIStateGrabbingCoin1::Exit()
{	
