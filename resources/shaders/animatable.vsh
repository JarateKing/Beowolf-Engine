...
void main()
{
	...
	//blendedPos += BoneMatrixArray[21] * a_position * 0.5; // a_boneWeights.x;
	//blendedPos += BoneMatrixArray[22] * a_position * 0.5; // a_boneWeights.y;
	//blendedPos += BoneMatrixArray[23] * a_position * 0.0; // a_boneWeights.z;
	//blendedPos += BoneMatrixArray[24] * a_position * 0.0; // a_boneWeights.w;
